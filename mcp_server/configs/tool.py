...
class ToolDefine:
    ...
    # get_creditor_management_suspension: dict = field(default_factory=lambda: {"name": "채권은행 등의 관리절차 중단", "base_url": os.getenv("BASE_URL",""), "endpoint": "", "api_key": os.getenv("DART_API_KEY","")}) # 5-19
