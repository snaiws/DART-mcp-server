...
class ApiDefineUnit:
    ...
    get_multi_company_accounts: dict = field(default_factory=lambda: {"name": "다중회사 주요계정", "base_url": "https://opendart.fss.or.kr/api", "endpoint": "/fnlttMultiAcnt.json", "api_key": os.getenv('DART_API_KEY')}) # 3-2
    ...
    get_overseas_listing: dict = field(default_factory=lambda: {"name": "해외 증권시장 주권등 상장", "base_url": "https://opendart.fss.or.kr/api", "endpoint": "/ovLst.json", "api_key": os.getenv('DART_API_KEY')}) # 5-14
    ...
    get_creditor_management_suspension: dict = field(default_factory=lambda: {"name": "채권은행 등의 관리절차 중단", "base_url": "https://opendart.fss.or.kr/api", "endpoint": "/bnkMngtPcsp.json", "api_key": os.getenv('DART_API_KEY')}) # 5-19
