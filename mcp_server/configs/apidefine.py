...
class ApiDefineUnit:
    ...
    get_capitalstatus: dict = field(default_factory=lambda: {"name": "증자(감자) 현황", "base_url": "https://opendart.fss.or.kr/api", "endpoint": "/irdsSttus.json"}) # 2-1
    # get_dividend_info: dict = field(default_factory=lambda: {"name": "배당에 관한 사항", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-2
    # get_treasury_stock: dict = field(default_factory=lambda: {"name": "자기주식 취득 및 처분 현황", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-3
    # get_major_shareholders: dict = field(default_factory=lambda: {"name": "최대주주 현황", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-4
    # get_major_shareholders_changes: dict = field(default_factory=lambda: {"name": "최대주주 변동현황", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-5
    # get_minority_shareholders: dict = field(default_factory=lambda: {"name": "소액주주 현황", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-6
    # get_executives: dict = field(default_factory=lambda: {"name": "임원 현황", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-7
    # get_employees: dict = field(default_factory=lambda: {"name": "직원 현황", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-8
    # get_individual_compensation_over_500m: dict = field(default_factory=lambda: {"name": "이사·감사의 개인별 보수현황(5억원 이상)", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-9
    # get_board_total_compensation: dict = field(default_factory=lambda: {"name": "이사·감사 전체의 보수현황(보수지급금액 - 이사·감사 전체)", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-10
    # get_top5_compensation_over_500m: dict = field(default_factory=lambda: {"name": "개인별 보수지급 금액(5억이상 상위5인)", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-11
    # get_investment_in_other_corp: dict = field(default_factory=lambda: {"name": "타법인 출자현황", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-12
    # get_total_shares: dict = field(default_factory=lambda: {"name": "주식의 총수 현황", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-13
    # get_debt_securities_issuance: dict = field(default_factory=lambda: {"name": "채무증권 발행실적", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-14
    # get_commercial_paper_balance: dict = field(default_factory=lambda: {"name": "기업어음증권 미상환 잔액", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-15
    # get_short_term_bond_balance: dict = field(default_factory=lambda: {"name": "단기사채 미상환 잔액", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-16
    # get_corporate_bond_balance: dict = field(default_factory=lambda: {"name": "회사채 미상환 잔액", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-17
    # get_hybrid_securities_balance: dict = field(default_factory=lambda: {"name": "신종자본증권 미상환 잔액", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-18
    # get_contingent_convertible_balance: dict = field(default_factory=lambda: {"name": "조건부 자본증권 미상환 잔액", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-19
    # get_auditor_opinion: dict = field(default_factory=lambda: {"name": "회계감사인의 명칭 및 감사의견", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-20
    # get_audit_service_contract: dict = field(default_factory=lambda: {"name": "감사용역체결현황", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-21
    # get_non_audit_service_contract: dict = field(default_factory=lambda: {"name": "회계감사인과의 비감사용역 계약체결 현황", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-22
    # get_outside_directors: dict = field(default_factory=lambda: {"name": "사외이사 및 그 변동현황", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-23
    # get_unregistered_executives_compensation: dict = field(default_factory=lambda: {"name": "미등기임원 보수현황", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 2-24
    ...
    # get_major_holding_reports: dict = field(default_factory=lambda: {"name": "대량보유 상황보고", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 4-1
    ...
    # get_creditor_management_start: dict = field(default_factory=lambda: {"name": "채권은행 등의 관리절차 개시", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 5-10
    # get_litigation_filing: dict = field(default_factory=lambda: {"name": "소송 등의 제기", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 5-11
    # get_overseas_listing_decision: dict = field(default_factory=lambda: {"name": "해외 증권시장 주권등 상장 결정", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 5-12
    # get_overseas_delisting_decision: dict = field(default_factory=lambda: {"name": "해외 증권시장 주권등 상장폐지 결정", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 5-13
    # get_overseas_listing: dict = field(default_factory=lambda: {"name": "해외 증권시장 주권등 상장", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 5-14
    ...
    get_convertible_bond_issuance: dict = field(default_factory=lambda: {"name": "전환사채권 발행결정", "base_url": "https://opendart.fss.or.kr/api", "endpoint": "/cvbdIsDecsn.json"}) # 5-16
    get_bond_with_warrants_issuance: dict = field(default_factory=lambda: {"name": "신주인수권부사채권 발행결정", "base_url": "https://opendart.fss.or.kr/api", "endpoint": "/bdwtIsDecsn.json"}) # 5-17
    ...
    # get_debt_securities_registration: dict = field(default_factory=lambda: {"name": "채무증권", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 6-2
    # get_depositary_receipts_registration: dict = field(default_factory=lambda: {"name": "증권예탁증권", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 6-3
    # get_merger_registration: dict = field(default_factory=lambda: {"name": "합병", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 6-4
    # get_comprehensive_stock_exchange_transfer_registration: dict = field(default_factory=lambda: {"name": "주식의포괄적교환,이전", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 6-5
    # get_split_registration: dict = field(default_factory=lambda: {"name": "분할", "base_url": "https://opendart.fss.or.kr/api", "endpoint": ""}) # 6-6
