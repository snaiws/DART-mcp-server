...
usecase_tools = UsecaseDefine().__dict__.get(configs.USECASE, [])
all_tools = ToolDefine().__dict__
tools = {k: all_tools[k] for k in usecase_tools if k in all_tools} if usecase_tools else all_tools
