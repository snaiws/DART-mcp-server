...
async def get_convertible_bond_issuance(
    base_url:str,
    endpoint:str,
    api_key:str, 
    corp_code:str, 
    ...
    transform1 = {
        ...
        "fdpp_ocsa": "자금조달목적 - 타법인 증권 취득자금 (원)",
        ...
        "cv_rt": "전환비율 (%)",
        "cv_prc": "전환가액 (원/주)",
        "cvisstk_knd": "전환으로 발행할 주식 종류",
        "cvisstk_cnt": "전환으로 발행할 주식수",
        "cvisstk_tisstk_vs": "전환주식의 주식총수 대비 비율(%)",
        "cvrqpd_bgd": "전환청구기간 시작일",
        "cvrqpd_edd": "전환청구기간 종료일",
        "act_mktprcfl_cvprc_lwtrsprc": "시가하락 전환가액조정 최저가격 (원)",
        "act_mktprcfl_cvprc_lwtrsprc_bs": "시가하락 전환가액조정 최저가격 근거",
        "rmislmt_lt70p": "전환가액 70% 미만 조정가능 잔여한도 (원)",
        "abmg": "합병 관련 사항",
        "sbd": "청약일",
        "pymd": "납입일",
        "rpmcmp": "대표주관회사",
