...
async def get_public_fund_usage(
    ...
    transform1 = {
        ...
        "on_dclrt_cptal_use_plan": "신고서상 자금사용 계획(2018년 1월 18일까지 사용된 사항)",
        "real_cptal_use_sttus": "실제 자금사용 현황(2018년 1월 18일까지 사용된 사항)",
        "rs_cptal_use_plan_useprps": "증권신고서 등의 자금사용 계획 사용용도(2018년 1월 19일부터 추가된 사항)",
        "rs_cptal_use_plan_prcure_amount": "증권신고서 등의 자금사용 계획 조달금액(2018년 1월 19일부터 추가된 사항)",
