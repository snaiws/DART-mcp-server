...
class Schema_get_complete_financial_statements(BaseModel):
   corp_code: str = Field(
   ...
   fs_div: str = Field(
        description="Financial statement type - Individual/Consolidated classification (3 characters) OFS: Individual financial statements, CFS: Consolidated financial statements"
   )